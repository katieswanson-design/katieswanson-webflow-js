/**
 * bunny-hls.js — Bunny HLS background video player.
 *
 * Migrated from Slater 51416.js (2026-09-11), which was the minified build of
 * the Osmo Supply resource "Bunny HLS Background Video". This is Osmo's source
 * form, unmodified — the Slater copy contained no local changes.
 * https://www.osmo.supply/resource/bunny-hls-background-video
 *
 * Requires hls.js to be loaded FIRST. Safari and iOS play HLS natively; every
 * other browser needs it, and without it the video silently never starts.
 *
 * Pairs with src/bunny-bg.css, which styles the data-player-status states.
 * See the README for the markup contract and the outstanding pause-control
 * question.
 */
...
// Initialize Bunny HLS Background Video
